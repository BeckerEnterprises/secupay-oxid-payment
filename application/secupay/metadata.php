...
$aModule = array(
    ...
    'blocks' => array(
        array('template' => 'page/checkout/payment.tpl', 'block' => 'select_payment', 'file' => 'out/blocks/page/checkout/payment/select_payment.tpl'),
        array('template' => 'page/checkout/order.tpl', 'block' => 'shippingAndPayment', 'file' => 'out/blocks/page/checkout/order/shippingAndPayment.tpl')
    ),
    'settings' => array(
        array('group' => 'secupay_main', 'name' => 'secupay_blMode', 'type' => 'select', 'value' => '0', 'constraints' => '0|1'),
        ...
        array('group' => 'secupay_main', 'name' => 'secupay_experience', 'type' => 'select', 'value' => '1', 'constraints' => '0|1'),
        array('group' => 'secupay_debit', 'name' => 'secupay_debit_active', 'type' => 'bool', 'value' => 'true'),
        array('group' => 'secupay_creditcard', 'name' => 'secupay_creditcard_active', 'type' => 'bool', 'value' => 'true'),
        ...
        array('group' => 'secupay_debit', 'name' => 'secupay_debit_delivery_adress', 'type' => 'select', 'value' => '0', 'constraints' => '0|1|2'),
        array('group' => 'secupay_invoice', 'name' => 'secupay_invoice_delivery_adress', 'type' => 'select', 'value' => '0', 'constraints' => '0|1|2'),
        array('group' => 'secupay_invoice', 'name' => 'secupay_invoice_autoinvoice', 'type' => 'select', 'value' => '1', 'constraints' => '0|1'),
        array('group' => 'secupay_invoice', 'name' => 'secupay_invoice_autosend', 'type' => 'select', 'value' => '1', 'constraints' => '0|1'),
        array('group' => 'secupay_main', 'name' => 'secupay_invoice_tautosend', 'type' => 'select', 'value' => '1', 'constraints' => '0|1')
    ),
    'templates' => array(
