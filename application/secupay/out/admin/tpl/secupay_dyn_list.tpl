    ...
    <table width="70%" style="float:left;margin-bottom: 20px;overflow:scroll;">
        ...
        <tr id="row.[{ $listitem.hash }]">
            ...
            <td valign="top" class="[{ $listclass}]">
                <div class="listitemfloating">[{ $listitem.hash }]</div>
            </td>
            <td valign="top" class="[{ $listclass}]">
                <div class="listitemfloating">[{ $listitem.transaction_id }]</div>
            </td>
            <td valign="top" class="[{ $listclass}]">
                <div class="listitemfloating">[{ $listitem.oxordernr }]</div>
            </td>
            <td valign="top" class="[{ $listclass}]">
                <div class="listitemfloating">[{ $listitem.payment_method}]</div>
            </td>
            <td valign="top" class="[{ $listclass}]">
                <div style="text-align: right;" class="listitemfloating">[{ $listitem.amount}]&euro;</div>
            </td>
            <td valign="top" class="[{ $listclass}]">
                <div class="listitemfloating">[{ $listitem.created }]</div>
            </td>
            <td valign="top" class="[{ $listclass}]">
                <div class="listitemfloating">[{ $listitem.status }]</div>
            </td>
            <td valign="top" class="[{ $listclass}]">
                <div class="listitemfloating">[{ $listitem.msg }]</div>
            </td>
            <td valign="top" class="[{ $listclass}]">
                <div class="listitemfloating">[{ $listitem.actions }]</div>
            </td>
        </tr>
        [{if $blWhite == "2"}]
        [{assign var="blWhite" value=""}]
...
[{foreach from=$mylist item=listitem}]
    ...
    <tr id="row.[{$_cnt}]">
        ...
        <td valign="top" class="[{ $listclass}]" height="15">
            <div class="listitemfloating">&nbsp;<a href="Javascript:top.oxid.admin.editThis('[{ $listitem->oxvoucherseries__oxid->value}]');" class="[{ $listclass}]">[{ if !$listitem->oxvoucherseries__oxserienr->value }]-[{ oxmultilang ident="GENERAL_NONAME" }]-[{else}][{ $listitem->oxvoucherseries__oxserienr->value }][{/if}]</a>
            </div>
        </td>
        <td valign="top" class="[{ $listclass}]">
            <div class="listitemfloating">
                <a href="Javascript:top.oxid.admin.editThis('[{ $listitem->oxvoucherseries__oxid->value }]');" class="[{$listclass}]">[{ $listitem->oxvoucherseries__oxdiscount->value }][{if $listitem->oxvoucherseries__oxdiscounttype->value == "percent"}] %[{/if}]</a>
            </div>
        </td>
        <td valign="top" class="[{ $listclass}]">
            <div class="listitemfloating">
                <a href="Javascript:top.oxid.admin.editThis('[{ $listitem->oxvoucherseries__oxid->value }]');" class="[{$listclass}]">[{ $listitem->oxvoucherseries__oxbegindate->value }]</a>
            </div>
        </td>
        <td valign="top" class="[{ $listclass}]">
            <div class="listitemfloating">
                <a href="Javascript:top.oxid.admin.editThis('[{ $listitem->oxvoucherseries__oxid->value }]');" class="[{$listclass}]">[{ $listitem->oxvoucherseries__oxenddate->value }]</a>
            </div>
        </td>
        <td valign="top" class="[{ $listclass}]">
            <div class="listitemfloating">
                <a href="Javascript:top.oxid.admin.editThis('[{ $listitem->oxvoucherseries__oxid->value }]');" class="[{$listclass}]">[{ $listitem->oxvoucherseries__oxminimumvalue->value }]</a>
            </div>
        </td>
        <td class="[{ $listclass}]">
            [{if !$readonly}]
